...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/13-Jalisco/cobrador/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/13-Jalisco/cobrador/clientes/lista_clientes.php" class="selected">
                <div class="option">
