...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/11-Guerrero/supervisor/inicio/inicio.php" class="selected">
                <div class="option">
            ...
            <a href="/resources/views/zonas/11-Guerrero/supervisor/clientes/lista_clientes.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/11-Guerrero      <i class="fa-solid fa-sack-xmark" title=""></i>
                    <h4>Gastos</h4>
                </div>
            </a>
