...
$sql_monto_pagar = "SELECT MontoAPagar FROM prestamos WHERE IDCliente = ? AND Zona ='Chihuahua'";
...
$sql_id_prestamo = "SELECT ID FROM prestamos WHERE IDCliente = ? AND Zona ='Chihuahua'";
...
function obtenerSiguienteClienteId($conexion, $id_cliente_actual) {
    ...
    $sql_siguiente_cliente = "SELECT ID FROM clientes WHERE ID > ? AND ZonaAsignada ='Chihuahua' ORDER BY ID ASC LIMIT 1";
