...
<body id="body">
    ...
    <header>
        ...
        <a href="/resources/views/zonas/6-Chihuahua/supervisor/retiros/agregar_retiros.php" class="botonn">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/6-Chihuahua/supervisor/retiros/retiros.php" class="selected">
                <div class="option">
