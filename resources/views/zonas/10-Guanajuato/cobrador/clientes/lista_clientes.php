...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/10-Guanajuato/cobrador/inicio/inicio.php" class="selected">
                <div class="option">
            ...
            <a href="/resources/views/zonas/10-Guanajuato/cobrador/clientes/lista_clientes.php">
                <div class="option">
    ...
    <main>
        ...
        <table>
            ...
            <tr>
                ...
                <td><a
                        href="/resources/views/zonas/10-Guanajuato/cobrador/abonos/crud_historial_pagos.php?clienteId=<?= $fila["ID"] ?>">pagos</a>
                </td>
            </tr>
            <?php } ?>
        </table>
