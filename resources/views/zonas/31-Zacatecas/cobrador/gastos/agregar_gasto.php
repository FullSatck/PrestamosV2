...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/usuarios/crudusuarios.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/usuarios/registrar.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/creditos/crudPrestamos.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/gastos/gastos.php" class="selected">
                <div class="option">
