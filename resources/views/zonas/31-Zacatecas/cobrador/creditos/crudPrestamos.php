...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/clientes/lista_clientes.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/clientes/agregar_clientes.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/creditos/crudPrestamos.php" class="selected">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/creditos/prestamos.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/gastos/gastos.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/ruta/ruta.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/cartera/lista_cartera.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/cobrador/abonos/abonos.php">
                <div class="option">
