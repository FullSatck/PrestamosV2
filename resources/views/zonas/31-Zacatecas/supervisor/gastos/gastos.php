...
<body id="body">
    ...
    <header>
        ...
        <a href="/resources/views/zonas/31-Zacatecas/supervisor/gastos/agregar_gasto.php" class="botonn">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/31-Zacatecas/supervisor/inicio/inicio.php">
            ...
            <a href="/resources/views/zonas/31-Zacatecas/supervisor/gastos/gastos.php" class="selected">
                <div class="option">
