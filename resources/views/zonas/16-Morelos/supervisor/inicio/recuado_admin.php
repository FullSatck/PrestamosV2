...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/15-Michoacan/supervisor/inicio/inicio.php" class="selected">
                <div class="option">
            ...
            <a href="/resources/views/zonas/15-Michoacan/supervisor/clientes/lista_clientes.php">
                <div class="option">
