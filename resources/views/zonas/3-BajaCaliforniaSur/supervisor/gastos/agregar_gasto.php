...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/3-BajaCaliforniaSur/supervisor/inicio/inicio.php">
            <a href="/resources/views/zonas//supervisor/usuarios/crudusuarios.php">
                <div class="option">
        ...
        <a href="/resources/views/zonas/3-BajaCaliforniaSur/supervisor/inicio/inicio.php">
            <a href="/resources/views/zonas//supervisor/usuarios/registrar.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/3-BajaCaliforniaSur/supervisor/gastos/gastos.php" class="selected">
                <div class="option">
