...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/25-Sonora/supervisor/ruta/lista_super.php" class="selected">
                <div class="option">
    ...
    <main>
        ...
        <div class="container-fluid">
            ...
            <table class="table">
                ...
                $sql = $conexion->prepare("SELECT Usuarios.ID, Usuarios.Nombre, Usuarios.Apellido, Usuarios.Email, Zonas.Nombre AS Zona, Roles.Nombre AS Rol FROM Usuarios JOIN Zonas ON Usuarios.Zona = Zonas.ID JOIN Roles ON Usuarios.RolID = Roles.ID WHERE Roles.ID = 3 AND Zonas.ID = 25"); // Filtra por el ID del rol de supervisor (2)
