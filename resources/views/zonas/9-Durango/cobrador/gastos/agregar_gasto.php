...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/9-Durango/cobrador/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/9-Durango/cobrador/usuarios/crudusuarios.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/9-Durango/cobrador/usuarios/registrar.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/9-Durango/cobrador/gastos/gastos.php" class="selected">
                <div class="option">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group">
                ...
                <select name="id_zona" id="id_zona" class="zona">
                    ...
                    <?php
                $sql_zonas = "SELECT * FROM Zonas WHERE Nombre = 'Durango'";
