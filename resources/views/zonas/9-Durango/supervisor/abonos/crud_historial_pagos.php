...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/9-Durango/cobrador/clientes/lista_clientes.php" class="selected">
                <div class="option">
            ...
            <a href="/resources/views/zonas/9-Durango/cobrador/retiros/retiros.php">
                <div class="option">
