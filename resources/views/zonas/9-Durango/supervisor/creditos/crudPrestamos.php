...
<div class="menu__side" id="menu_side">
    ...
    <div class="options__menu">
        ...
        <a href="/resources/views/zonas/9-Durango/supervisor/creditos/crudPrestamos.php" class="selected">
            <div class="option">
        ...
        <a href="/resources/views/zonas/9-Durango/supervisor/gastos/gastos.php">
            <div class="option">
