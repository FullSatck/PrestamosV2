...
if ($resultado->num_rows === 1) {
    ...
    header("location: /resources/views/zonas/28-Tlaxcala/supervisor/inicio/prestadia/prestamos_del_dia.php");
    exit();
}
...
<body>
    ...
    <body id="body">
        ...
        WHERE c.ID = ? AND p.Estado = 'pendiente' AND c.ZonaAsignada = 'Tlaxcala'";
