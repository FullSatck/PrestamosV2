                    ...
                    <?php while ($fila = $resultado->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/resources/views/zonas/28-Tlaxcala/supervisor/creditos/prestamos.php?cliente_id=<?= $fila["ID"] ?>" class="boton-hacer-prestamo">
                            ...
                            <td>
                                <a href="/resources/views/zonas/28-Tlaxcala/supervisor/desatrasar/hacerPrestamo.php?clienteId=<?= $fila["ID"] ?>" class="boton-hacer-prestamo boton-rojo">
                                    <i class="fas fa-hand-holding-usd"></i>
                                    <span>Prest Atrasado</span>
                                </a>
                            </td>
                            <td><a href="../../../../../../controllers/perfil_cliente.php?id=<?= $fila["ID"] ?>">Perfil</a></td>
                            <td><a href="/resources/views/zonas/28-Tlaxcala/supervisor/abonos/crud_historial_pagos.php?clienteId=<?= $fila["ID"] ?>">pagos</a>
                            </td>
                        </tr>
                    <?php } ?>
                </table>
