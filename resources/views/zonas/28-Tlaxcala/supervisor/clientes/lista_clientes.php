            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if ($tiene_permiso_hacer_prestamo) : ?>
                        <a href="/resources/views/zonas/28-Tlaxcala/supervisor/creditos/prestamos.php?cliente_id=<?= $fila["ID"] ?>"
                    ...
                    <?php if ($tiene_permiso_desatrasar) : ?>
                    <td>
                        <a href="/resources/views/zonas/28-Tlaxcala/supervisor/desatrasar/hacerPrestamo.php?clienteId=<?= $fila["ID"] ?>"
                    ...
                    <td><a
                            href="/resources/views/zonas/28-Tlaxcala/supervisor/abonos/crud_historial_pagos.php?clienteId=<?= $fila["ID"] ?>">pagos</a>
                    </td>
                </tr>
                <?php } ?>
            </table>
