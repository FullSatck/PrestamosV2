...
<div class="menu__side" id="menu_side">
    ...
    <div class="options__menu">
        ...
        <a href="/resources/views/zonas/21-Queretaro/supervisor/clientes/lista_clientes.php">
            <div class="option">
        ...
        <a href="/resources/views/zonas/21-Queretaro/supervisor/creditos/crudPrestamos.php" class="selected">
            <div class="option">
