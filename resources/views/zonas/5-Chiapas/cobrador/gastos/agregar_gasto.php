...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/5-Chiapas/cobrador/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/5-Chiapas/cobrador/usuarios/crudusuarios.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/5-Chiapas/cobrador/usuarios/registrar.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/5-Chiapas/cobrador/gastos/gastos.php" class="selected">
                <div class="option">
