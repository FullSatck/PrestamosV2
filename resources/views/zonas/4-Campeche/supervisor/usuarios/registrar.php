...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/4-Campeches/supervisor/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/4-Campeche/supervisor/usuarios/registrar.php" class="selected">
                <div class="option">
            ...
            <form action="/controllers/super/validar_registro.php" method="post">
                ...
                <div class="input-container">
                    ...
                    <select id="zona" name="zona" required>
                        ...
                        $consultaZonas = "SELECT ID, Nombre FROM zonas WHERE Nombre = 'Campeche'";
