...
try {
    ...
    $sqlComisiones = "SELECT SUM(Comision) AS TotalComisiones FROM prestamos WHERE Zona = 'Campeche'";
        ...
        <div class="cuadros-container">
            <div class="cuadro cuadro-1">
                <div class="cuadro-1-1">
                    <a href="/resources/views/zonas/4-Campeche/cobrador/inicio/cobro_inicio.php" class="titulo">Prestamos</a><br>
                    <p>Mantenimiento
                    </p>
                </div>
            </div>
