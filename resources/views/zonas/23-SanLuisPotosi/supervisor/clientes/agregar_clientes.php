...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/23-SanLuisPotosi/supervisor/clientes/agregar_clientes.php" class="selected">
                <div class="option">
    ...
    <main>
        ...
        <form action="/controllers/super/validar_clientes.php" method="POST"
            ...
            <div class="input-container">
                ...
                $consultaZonas = "SELECT ID, Nombre FROM Zonas WHERE Nombre = 'SanLuisPotosi'";
