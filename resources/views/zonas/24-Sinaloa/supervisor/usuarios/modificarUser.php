...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/24-Sinaloa/supervisor/inicio/inicio.php">
            ...
            <a href="/resources/views/zonas/24-Sinaloa/supervisor/usuarios/crudusuarios.php" class="selected">
                <div class="option">
    ...
    <main>
        ...
        <form method="post">
            ...
            <div>
                <label for="contrasena">Nueva Contraseña: <br><p class="pp">(dejar en blanco para no cambiar)</p></label>
