...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/24-Sinaloa/supervisor/usuarios/registrar.php" class="selected">
                <div class="option">
    ...
    <!-- ACA VA EL CONTENIDO DE LA PAGINA -->
        ...
        <main>
            ...
            <form action="/controllers/super/validar_registro/validar_registro24.php" method="post">
