...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/24-Sinaloa/supervisor/creditos/prestamos.php" class="selected">
                <div class="option">
    ...
    <main>
        ...
        <form action="/controllers/super/procesar_prestamo/procesar_prestamo24.php" method="POST" class="form-container">
            <?php
