...
$sql_monto_pagar = "SELECT MontoAPagar FROM prestamos WHERE IDCliente = ? AND Zona ='Quintana Roo'";
...
$sql_id_prestamo = "SELECT ID FROM prestamos WHERE IDCliente = ? AND Zona ='Quintana Roo'";
...
function obtenerSiguienteClienteId($conexion, $id_cliente_actual) {
    ...
    $sql_siguiente_cliente = "SELECT ID FROM clientes WHERE ID > ? AND ZonaAsignada ='Quintana Roo' ORDER BY ID ASC LIMIT 1";
