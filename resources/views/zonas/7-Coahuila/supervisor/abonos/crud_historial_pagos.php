...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/7-Coahuila/cobrador/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/7-Coahuila/cobrador/clientes/lista_clientes.php" class="selected">
                <div class="option">
            ...
            <a href="/resources/views/zonass/cobrador/creditos/crudPrestamos.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas//cobrador/ruta/lista_super.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/7-Coahuila/cobrador/retiros/retiros.php">
                <div class="option">
