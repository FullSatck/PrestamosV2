...
<body id="body">
    ...
    <header>
        ...
        <a href="/resources/views/zonas/7-Coahuila/supervisor/gastos/agregar_gasto.php" class="botonn">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/7-Coahuila/supervisor/inicio/inicio.php">
            ...
            <a href="/resources/views/zonas/7-Coahuila/supervisor/gastos/gastos.php" class="selected">
                <div class="option">
