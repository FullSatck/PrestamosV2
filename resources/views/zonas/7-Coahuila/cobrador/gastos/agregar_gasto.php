...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/7-Coahuila/cobrador/inicio/inicio.php">
            ...
            <a href="/resources/views/zonas/7-Coahuila/cobrador/usuarios/crudusuarios.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/7-Coahuila/cobrador/usuarios/registrar.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/7-Coahuila/cobrador/gastos/gastos.php" class="selected">
                <div class="option">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group">
                ...
                <select name="id_zona" id="id_zona" class="zona">
                    ...
                    <?php
                $sql_zonas = "SELECT * FROM Zonas WHERE Nombre = 'Coahuila'";
