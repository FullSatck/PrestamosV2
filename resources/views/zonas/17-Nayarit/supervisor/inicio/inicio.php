...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/supervisor/inicio/inicio.php" class="selected">
                <div class="option">
        ...
        <div class="cuadros-container">
            <div class="cuadro cuadro-1">
                <div class="cuadro-1-1">
                    <a href="/resources/views/admin/inicio/cobro_inicio.php" class="titulo">Cuadro 1</a><br>
                    <p>Mantenimiento</p>
                </div>
            </div>
            <div class="cuadro cuadro-3">
                <div class="cuadro-1-1">
                    <a href="/resources/views/admin/inicio/recuado_admin.php" class="titulo">Cuadro 2</a><br>
                    <p>Mantenimiento</p>
                </div>
            </div>
            ...
            <div class="cuadro cuadro-4">
                <div class="cuadro-1-1">
                    <a href="##" class="titulo">Cuadro 4</a>
                    <p>Mantenimiento</p>
                </div>
            </div>
        </div>
