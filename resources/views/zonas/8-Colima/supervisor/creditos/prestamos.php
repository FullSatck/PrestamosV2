...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/8-Colima/supervisor/creditos/prestamos.php" class="selected">
                <div class="option">
    ...
    <main>
        ...
        <form action="/controllers/super/procesar_prestamo.php" method="POST" class="form-container">
            ...
            $query_clientes = "SELECT ID, Nombre FROM Clientes WHERE ZonaAsignada = 'Colima'";
            $query_monedas = "SELECT ID, Nombre, Simbolo FROM Monedas";
            $query_zonas = "SELECT Nombre FROM Zonas WHERE Nombre = 'Colima'";
