...
<body id="body">
    ...
    <header>
        ...
        <a href="/resources/views/zonas/8-Colima/supervisor/retiros/agregar_retiros.php" class="botonn">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/8-Colima/supervisor/ruta/lista_super.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/8-Colima/supervisor/retiros/retiros.php" class="selected">
                <div class="option">
