...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <a href="/resources/views/zonas/8-Colima/cobrador/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/8-Colima/cobrador/usuarios/crudusuarios.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/8-Colima/cobrador/usuarios/registrar.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/8-Colima/cobrador/gastos/gastos.php" class="selected">
                <div class="option">
