...
<body>
    ...
    <header>
        <div class="container mt-3">
            ...
            <a href="/resources/views/zonas/20-Puebla/supervisor/inicio/inicio.php" class="btn btn-primary">Ir al Inicio</a>
        </div>
    </header>
    <div class="container mt-5">
        ...
        WHERE p.Estado = 'pagado' AND p.Zona = 'Puebla'";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>
                            ...
                            <td><a href='/resources/views/zonas/20-Puebla/supervisor/creditos/prestamos.php?cliente_id=" . $row["IDCliente"] . "' class='btn btn-primary btn-sm'>Hacer Préstamo</a></td>
                        </tr>";
                }
                echo "</tbody></table>";
            } else {
