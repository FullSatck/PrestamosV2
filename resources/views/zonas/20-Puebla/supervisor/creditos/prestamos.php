...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href=" /resources/views/zonas/20-Puebla/supervisor/admin_saldo/saldo_admin.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/20-Puebla/supervisor/cobros/cobros.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/20-Puebla/supervisor/ruta/ruta.php">
                <div class="option">
    ...
    <main>
        ...
        <form action="/controllers/super/procesar_prestamos/procesar_prestamo20.php" method="POST" class="form-container">
            <?php
