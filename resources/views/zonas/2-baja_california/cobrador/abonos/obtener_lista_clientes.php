...
$sql = "SELECT ID FROM clientes WHERE ZonaAsignada  = 'Baja California' AND Estado = 1 AND NOT Estado = 'pagado'"; // Selecciona solo los clientes de la Zona 1 que están activos
