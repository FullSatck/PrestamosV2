...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources2-baja_california/supervisor/inicio/inicio.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas/2-baja_california/supervisor/ruta/lista_super.php" class="selected">
                <div class="option">
