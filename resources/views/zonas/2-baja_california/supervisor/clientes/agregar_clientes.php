...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas/2-baja_california/supervisor/clientes/agregar_clientes.php" class="selected">
                <div class="option">
    ...
    <main>
        ...
        <form action="/controllers/super/validar_clientes/validar_clientes2.php" method="POST"
