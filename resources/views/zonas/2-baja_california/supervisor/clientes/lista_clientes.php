...
<body id="body"> 
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="/resources/views/zonas2-baja_california/supervisor/ruta/lista_super.php">
                <div class="option">
            ...
            <a href="/resources/views/zonas2-baja_california/supervisor/abonos/abonos.php">
                <div class="option">
                    <i class="fa-solid fa-money-bill-trend-up" title=""></i>
                    <h4>Abonos</h4>
                </div>
            </a>
            <a href="/resources/views/zonas2-baja_california/supervisor/retiros/retiros.php">
                <div class="option">
